...
import { Shield, Camera, Image, History, Settings, TriangleAlert, Zap, Flame } from 'lucide-react'
    ...
    <Layout>
      ...
      <div className="flex-1 flex flex-col items-center justify-start px-5 pt-10 pb-6">
        ...
        <div className="w-full bg-slate-50 rounded-2xl p-5 border border-slate-100">
          <p className="text-xs text-slate-500 text-center mb-4">AI가 자동으로 탐지하는 위험 요소</p>
          <div className="flex justify-around">
            {hazardTypes.map(({ label, icon: Icon, iconColor, bg }) => (
        ...
        <p className="text-xs text-slate-400 text-center mt-4 leading-relaxed">
          추락, 감전, 화재 등 위험 요소를 자동 탐지하고<br />예방 방법을 제공합니다
        </p>
      </div>
