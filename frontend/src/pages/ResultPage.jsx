...
// TODO: useLocation()으로 실제 API 결과 받아오기
const MOCK_HAZARDS = [
  {
    id: 1,
    title: '사다리 고정 장치 미설치',
    desc: '사다리가 벽면에 고정되지 않아 전도 위험이 있습니다.',
    severity: '높음',
...
const MOCK_LAWS = [
  {
    ...
    title: '산업안전보건규칙 제32조',
    subtitle: '통로',
    content: '통로의 주요 부분에는 통로임을 표시하고, 항상 안전한 상태를 유지하여야 합니다.',
  },
  {
    id: 2,
    title: '산업안전보건규칙 제311조',
    subtitle: '전기설비의 점검',
    content: '전기기계·기구는 정기적으로 점검하고 이상이 있을 경우 즉시 수리해야 합니다.',
  },
  {
    id: 3,
    title: '산업안전보건규칙 제24조',
    subtitle: '작업장 바닥',
    content: '작업장 바닥은 안전하고 청결한 상태를 유지하여야 합니다.',
  },
]
            ...
            <div key={h.id} className="bg-white rounded-2xl border border-slate-200 p-4 flex items-start gap-3">
              ...
              <div className="flex-1 min-w-0">
                <div className="flex items-start justify-between gap-2 mb-1">
                  ...
                  <span className={`text-xs font-semibold px-2 py-0.5 rounded-full flex-shrink-0 ${h.severityColor}`}>
                    {h.severity}
                  </span>
                </div>
